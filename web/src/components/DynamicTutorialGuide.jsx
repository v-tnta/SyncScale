...
const DynamicTutorialGuide = ({
    ...
    const getStepDetails = useCallback(() => {
        switch (step) {
            ...
            case 9:
                return {
                    title: "9/14. 手動できろくタブに切り替えましょう ⏱️",
